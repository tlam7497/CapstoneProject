...
data_words = []
asin = []
with open('LDA_textreviews_amazon.tsv','r') as f:
    next(f)
...
def compute_coherence_values(dictionary, corpus, texts, limit, start=2, step=3):
    ...
    for num_topics in range(start, limit, step):
        ...
        model = gensim.models.ldamulticore.LdaMulticore(corpus= corpus, id2word=id2word, num_topics= num_topics, workers=6, random_state = 256)
...
plt.title('Optimal Number of LDA Topics with Coherence score (Amazon)')
#plt.legend(("coherence_values"), loc='best')
plt.savefig('LDA_amazon_optimal_topic_step5.png')
topic = {}
i = 0
...
print('--------------------7')
num_topic = maxNum
with open ('am_LDA_wmallet_step5_metadata.csv', 'w') as w: 
